...
utilities/%.o: ../utilities/%.S utilities/subdir.mk
	...
	arm-none-eabi-gcc -c -x assembler-with-cpp -D__REDLIB__ -I"C:\Embebidos_Redes\Prac2\prac2_612_t3_lwip_mqtt_freertos_seR2\freertos\freertos-kernel\include" -I"C:\Embebidos_Redes\Prac2\prac2_612_t3_lwip_mqtt_freertos_seR2\source" -g3 -gdwarf-4 -mcpu=cortex-m33+nodsp -mfpu=fpv5-sp-d16 -mfloat-abi=hard -mthumb -D__REDLIB__ -specs=redlib.specs -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
